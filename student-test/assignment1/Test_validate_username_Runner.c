...
int Test_validate_username_main(void)
{
  UnityBegin("/home/felix/Projects/Coursera/linux_systemprogrammierung_einfuehrung_buildroot/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
